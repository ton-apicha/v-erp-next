...
export default async function AgentProfilePage({
    ...
    const agent = await prisma.agent.findUnique({
        ...
        include: {
            workers: {
                ...
                select: { id: true, status: true, firstNameTH: true, lastNameTH: true, workerId: true, createdAt: true },
            },
            commissions: {
    ...
    const recentWorkers = agent.workers.slice(0, 5)
                    ...
                    <Card>
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                ...
                                <DocumentUpload agentId={id} />
                            </div>
                        </CardHeader>
                        <CardContent>
                            <DocumentList documents={agent.documents} />
                        </CardContent>
                    </Card>
